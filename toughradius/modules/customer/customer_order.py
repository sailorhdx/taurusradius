...
class CustomerOrderHandler(CustomerHandler):
    ...
    def post(self):
        ...
        _query = self.db.query(models.TrCustomerOrder.order_id, models.TrCustomerOrder.account_number, models.TrCustomerOrder.pay_status, models.TrCustomerOrder.order_fee, models.TrCustomerOrder.actual_fee, models.TrCustomerOrder.create_time.label('begin_time'), models.TrCustomerOrder.order_source, models.TrCustomerOrder.order_desc, models.TrCustomer.node_id, models.TrCustomer.realname, models.TrAccount.status, models.TrAccount.create_time, models.TrAccount.expire_date, models.TrProduct.product_name, models.TrNode.node_name).filter(models.TrCustomerOrder.product_id == models.TrProduct.id, models.TrCustomerOrder.customer_id == models.TrCustomer.customer_id, models.TrCustomerOrder.customer_id == models.TrAccount.customer_id, models.TrNode.id == models.TrCustomer.node_id)
        if node_id:
