...
product_add_actions = ((u'预付费包月', '/admin/product/add?product_policy=0'),
 ...
 (u'预付费包月流量', '/admin/product/ppmf/add'))
...
@permit.suproute('/admin/product', u'资费套餐管理', MenuRes, order=3.0, is_menu=True)
...
class ProductAddListHandler(BaseHandler):
    ...
    def get(self):
        ...
        form = product_forms.product_add_form(charges=charges)
...
class ProductUpdateListHandler(BaseHandler):
    ...
    def get(self):
        ...
        form = product_forms.product_update_form(charges=charges)
...
@permit.suproute('/admin/product/detail', u'资费详情', MenuRes, order=3.0004)
